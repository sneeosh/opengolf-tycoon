...
const PROPERTIES: Dictionary = {
	...
	Type.GREEN: {"name": "Green", "color": Color(0.35, 0.88, 0.45), "playable": true, "placement_cost": 20, "maintenance_cost": 3, "shot_difficulty": 0.0},
	Type.TEE_BOX: {"name": "Tee Box", "color": Color(0.45, 0.75, 0.42), "playable": true, "placement_cost": 12, "maintenance_cost": 2, "shot_difficulty": 0.0},
