...
| Parkland buildings | `assets/sprites/buildings/{pro_shop,snack_bar,restroom,bench,driving_range}.png` | Existing per-slot canvases | `visual_pipeline/parkland-generation-record.json` | Gemini 3.1 Flash Image Preview | $0.49 | Integrated | Shared cream, cedar, and deep-green material family. Driving range replaced after runtime review with a deeper three-station pavilion. Old window-glow coordinates disabled for replaced art. |
| Parkland trees | `assets/sprites/trees/{oak,pine}.png` | 54x84; 48x80 | `visual_pipeline/parkland-generation-record.json` | Gemini 3.1 Flash Image Preview | $0.21 | Partially integrated | Pine and summer oak validated in Forward+; spring/fall/winter oak and winter pine still use the older seasonal family. Entity ground offsets updated. |
| Parkland props | `assets/sprites/rocks/small.png`, `assets/sprites/tiles/flower_bed.png`, `assets/sprites/flag/flag.png`, `assets/sprites/golf_cart/golf_cart.png` | Existing per-slot canvases | `visual_pipeline/parkland-generation-record.json` | Gemini 3.1 Flash Image Preview | $0.28 | Partially integrated | Small rock is active and runtime-validated. Flower-bed terrain and gameplay flags remain procedural; golf-cart art has no active consumer yet. |
...
Parkland asset-set total: approximately **$1.49**, including the $0.07 clubhouse generated before the final slice approval. The initial approved slice work was approximately **$1.35**, below its $1.40 cap; a separately authorized $0.07 post-validation driving-range replacement brings cumulative slice work to **$1.42**. Generated candidates and video frames remain under ignored `.visual-pipeline/`; only reviewed runtime assets are committed.

Runtime validation results and follow-ups are recorded in `docs/parkland-runtime-validation.md`.
